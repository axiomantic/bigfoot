...
def test_unary_unary_basic_interception(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Do", returns=b"response-data")
...
def test_missing_fields_raises_error(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Do", returns=b"val")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
        stub = channel.unary_unary("/pkg.Svc/Do")
        stub(b"req")
...
def test_assert_unary_unary_helper(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Do", returns=b"ok")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
        stub = channel.unary_unary("/pkg.Svc/Do")
        stub(b"req")
...
def test_assert_unary_stream_helper(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_stream("/pkg.Svc/ServerStream", returns=[b"r1", b"r2"])
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_assert_stream_unary_helper(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_stream_unary("/pkg.Svc/ClientStream", returns=b"merged")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_assert_stream_stream_helper(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_stream_stream("/pkg.Svc/Bidi", returns=[b"s1", b"s2"])
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_exception_propagation(tripwire_verifier: StrictVerifier) -> None:
    ...
    err = grpc.RpcError()
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Fail", returns=None, raises=err)
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_server_streaming_returns_iterator(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_stream("/pkg.Svc/Stream", returns=[b"a", b"b", b"c"])
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_client_streaming_materializes_request(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_stream_unary("/pkg.Svc/Upload", returns=b"done")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_bidi_streaming(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_stream_stream("/pkg.Svc/Chat", returns=[b"r1", b"r2"])
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_empty_streams(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_stream_stream("/pkg.Svc/Empty", returns=[])
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_mid_stream_error(tripwire_verifier: StrictVerifier) -> None:
    ...
    err = grpc.RpcError()
    tripwire.grpc.mock_unary_stream("/pkg.Svc/PartialFail", returns=[b"p1", b"p2"], raises=err)
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_fifo_queue_ordering(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Do", returns=b"first")
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Do", returns=b"second")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
        stub = channel.unary_unary("/pkg.Svc/Do")
        r1 = stub(b"req1")
...
def test_unmocked_after_queue_exhausted(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Do", returns=b"only-one")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
        stub = channel.unary_unary("/pkg.Svc/Do")
...
def test_metadata_passed_through(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Auth", returns=b"ok")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
def test_secure_channel_interception(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Secure", returns=b"secure-ok")
    with tripwire.sandbox():
...
def test_format_mock_hint() -> None:
    ...
    assert p.format_mock_hint(interaction) == (
        "    tripwire.grpc.mock_unary_unary('/pkg.Svc/Do', returns=...)"
    )
...
# ---------------------------------------------------------------------------
# Module-level proxy: tripwire.grpc
# ---------------------------------------------------------------------------


# ESCAPE: test_grpc_mock_proxy_works
#   CLAIM: tripwire.grpc.mock_unary_unary() works when verifier is active.
...
def test_grpc_mock_proxy_works(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Proxy", returns=b"proxy-ok")
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
...
#   CLAIM: GrpcPlugin and grpc are exported in tripwire.__all__.
...
def test_grpc_plugin_in_all() -> None:
    ...
    assert "grpc" in tripwire.__all__
...
def test_separate_queues_per_call_type(tripwire_verifier: StrictVerifier) -> None:
    ...
    tripwire.grpc.mock_unary_unary("/pkg.Svc/Multi", returns=b"unary-resp")
    tripwire.grpc.mock_unary_stream("/pkg.Svc/Multi", returns=[b"stream-resp"])
    with tripwire.sandbox():
        channel = grpc.insecure_channel("localhost:50051")
